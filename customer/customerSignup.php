        ...
        if (empty($_POST['confirm'])) {
            ...
            if ($user_password == $user_ucpassword) {
                ...
                if ($errcount == 0) {
                    ...
                    $sql = 'INSERT INTO "USER" (USER_ID,FIRSTNAME,LASTNAME,ROLE,EMAIL_ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH,ADDRESS,PASSWORD,GENDER,STATUS) VALUES(:user_id,:HFIRSTNAME,:HLASTNAME,:HROLE,:HEMAIL,:HPHONE,:HDOB,:HADDRESS,:HPASSWORD,:HGENDER,:HVERIFY)';
