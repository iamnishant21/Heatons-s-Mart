...
if (isset($_POST['subShop'])) {
    ...
    $sql = 'SELECT * FROM "SHOP" WHERE SHOP_NAME= :HSHOPNAME';
            ...
            if($error_count == 0)  {
                    $sql = 'INSERT INTO "SHOP" (USER_ID,SHOP_NAME,SHOP_ADDRESS,SHOP_PHONENUMBER,SHOP_CATEGORY,SHOP_DESCRIPTION) 
                        VALUES (:HUSER_ID,:SHOP_NAME,:HSHOP_ADDRESS,:HPHONE_NUMBER,:HCATEGORY,:HDESCRIPTION)';
