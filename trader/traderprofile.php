...
<?php
  ...
  // $user = 120;
  $firstname =  $lastname = $gender =  $contact = $email =$address = $dob=''; 
...
<head>
    ...
    <link rel="stylesheet" href="traderprofile.css">
    ...
    <nav class="navbar navbar-expand-lg navbar-light ">
        <div class="container">
          ...
          <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="traderdashboard.php">Back to traderdashboard</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="traderprofile.php">Trader Profile</a>
              </li>
            </ul>
            <div class="main">
            </div>
      ...
      <div class="modal-footer">
        ...
        <div class="footer">
            <div class="box1">
                ...
                <a href="../Home/homepage.php">Product</a>            
