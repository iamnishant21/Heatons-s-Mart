...
<body>
    ...
    $resgister_fname = $resgister_lname = $resgister_email = $resgister_gender = $resgister_category = $resgister_password = $resgister_cpassword =  $resgister_check = '';
        ...
        if (empty($_POST['confirm'])) {
            ...
            if ($user_password == $user_cpassword) {
                if (preg_match($pattern, $user_password) == false) {
                    ...
                    $role = "trader";
                    $sql = 'INSERT INTO "USER" (USER_ID,FIRSTNAME,LASTNAME,ROLE,EMAIL_ADDRESS,CATEGORY,GENDER,PASSWORD)
                    VALUES(:user_id,:HFIRSTNAME,:HLASTNAME,:HROLE,:HEMAIL,:HCATEGORY,:HGENDER,:HPASSWORD)';
