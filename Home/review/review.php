...
<body>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                    <?php echo"<img src='../../trader/uploads/$p_image' class='img img-rounded img-fluid'>";
                     ?>
  ...
  <div class="about">
    <div class="aboutus">
        <h3>ABOUT US</h3>
        <p>At HeatonsMart, we are your ultimate destination for all your grocery needs. We bring together a delightful selection of bakery products, fresh meats from our butcher shop, a wide variety of fish, and an extensive range of grocery items. With HeatonsMart, you can conveniently shop for all your kitchen essentials in one place.  Join us at HeatonsMart and experience the convenience, quality, and variety that we have to offer. Start your grocery shopping journey with us today!
    </div>
</div>
<div class="footer">
    <div class="box1">
